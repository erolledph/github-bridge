          ...
          <div className="ml-3">
            ...
            <div className="mt-1 text-sm text-blue-700">
              <ul className="list-disc list-inside space-y-1">
                <li><code className="bg-blue-100 px-1 rounded">repo</code> - Full control of private repositories</li>
                <li><code className="bg-blue-100 px-1 rounded">user:email</code> - Access to user email addresses</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-3 py-3 pr-10 border rounded-lg focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors bg-white border-gray-300 text-gray-900 placeholder-gray-500"
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="flex-1 bg-green-600 hover:bg-green-700 disabled:bg-gray-400 text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center"
          >
            {isValidating ? (
              <>
          ...
          <a
            ...
            className="flex-1 border-2 border-gray-300 hover:border-gray-400 font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center text-gray-700 hover:bg-gray-50"
          >
